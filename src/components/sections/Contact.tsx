        ...
        >
          ...
          <motion.div className="flex flex-col gap-6">
            <SectionHeading
              ...
              subtitle="We're currently taking on new projects. Let's talk about what we can build together."
            ...
            <motion.p
              ...
              className="sr-only"
            >
              We&apos;re currently taking on new projects. Let&apos;s talk about what we can build together.
            </motion.p>
